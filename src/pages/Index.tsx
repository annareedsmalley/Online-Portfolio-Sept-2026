      ...
      <section className="bg-background hero-enter">
        <div className="mx-auto max-w-content xl:max-w-[min(1312px,70vw)] px-6 pb-4 pt-12 md:px-16 md:pb-5 md:pt-16">
          <Reveal>
            ...
            <h1 className="mt-6 max-w-full font-display font-normal text-[32px] leading-[1.05] text-title md:mt-8 lg:max-w-[75%] md:text-[clamp(40px,6.5vw,68px)]">
              Building Teams<br />That Build For All
            </h1>
            <p className="font-inter text-body leading-[1.5] mt-6 max-w-full text-base md:mt-8 lg:max-w-[58%] md:text-lg">
              Oh hi - I'm Anna Smalley, a design leader with <span className="font-semibold text-title">17+ years</span> turning cross-functional groups into high-performing, happy teams and shipping 80+ products across <span className="font-semibold text-title">Gap Inc</span>, <span className="font-semibold text-title">Salesforce</span> and <span className="font-semibold text-title">Walmart</span>. My greatest passion is universal design: starting with the people most often excluded, then creating experiences that end up better for everyone. I'm based in the <span className="font-semibold text-title">SF Bay Area</span>, and I'm currently looking for a <span className="font-semibold text-title">mission-driven,</span> <span className="font-semibold text-title">joyful team</span> that prioritizes <span className="font-semibold text-title">inclusion</span>.
            </p>
          </Reveal>
        </div>
      </section>
