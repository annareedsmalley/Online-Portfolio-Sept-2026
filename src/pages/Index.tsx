      ...
      <section className="bg-background hero-enter">
        <div className="mx-auto max-w-content xl:max-w-[min(1312px,70vw)] px-6 pb-4 pt-4 md:px-16 md:pb-5 md:pt-5">
          <Reveal>
            ...
            <p className="body-text mt-6 max-w-[66%] text-base md:mt-8 md:text-lg lg:max-w-[58%] xl:max-w-[53%] whitespace-pre-line">
              {`Oh hi - I'm Anna Smalley, a design leader with 17+ years turning cross-functional groups into high-performing, happy teams and shipping 50+ products across Gap Inc, Salesforce and Walmart.\n\nMy greatest passion is universal design: starting with the people most often excluded, then creating experiences that end up better for everyone.\n\nI'm based in the SF Bay Area, and I'm currently looking for a mission-driven team to lead or support while we build something great.`}
            </p>
          </Reveal>
        </div>
      </section>
