  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-background scroll-mt-16">
      ...
      <div className="relative z-10 mx-auto max-w-content px-6 pt-14 pb-20 md:px-16 md:pt-[72px] md:pb-28">
        <div className="mx-auto flex max-w-2xl flex-col items-center gap-8 rounded-lg border border-title/[0.08] bg-background/55 px-8 py-12 text-center shadow-[0_1px_1px_hsl(var(--title)/0.03),0_16px_40px_-20px_hsl(var(--title)/0.14)] backdrop-blur-[2px] md:gap-10 md:px-16 md:py-16">
          <div>
