        ...
        >
          ...
          <article className="flex min-w-0 flex-col gap-4 [&_section:first-of-type_h2:first-of-type]:mt-0 [&_h2+h3]:mt-6 [&_h3+h4]:mt-0">
            ...
            <Section id="first-battle">
              ...
              <P>
                We rallied: <strong>"These assumptions need to be challenged.</strong> We need time to put this in front of customers, look at best practices, and review competitors."
              </P>
              <P>
