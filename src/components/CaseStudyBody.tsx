...
const H2 = ({ id, children }: { id: string; children: ReactNode }) => (
  <h2
    id={id}
    className="scroll-mt-28 font-serif text-[32px] leading-[1.15] text-title md:text-[40px] mt-12"
  >
    {children}
  </h2>
);
        ...
        >
          ...
          <article className="flex min-w-0 flex-col gap-0 [&_section:first-of-type_h2]:mt-0">
            ...
            <Section id="structuring-work">
              ...
              <KeyInsight color="blue" rotate={2} label="Key insight">
            ...
            <Section id="first-solution">
              ...
              <P>
                The guidelines were concrete: <strong>move forward with denim PDP with up to four attributes.</strong> Place products with different size types on separate pages.
              </P>
              <P>
