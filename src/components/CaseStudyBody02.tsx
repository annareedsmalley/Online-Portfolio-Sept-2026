...
const UL = ({ children }: { children: ReactNode }) => (
  <ul className="body-text flex list-disc flex-col space-y-1 pl-6 text-[16px] leading-[1.4] md:text-[17px] [&_strong]:font-semibold [&_strong]:text-title">
    {children}
  </ul>
);
        ...
        >
          ...
          <article className="flex min-w-0 flex-col gap-0 [&_section:first-of-type_h2]:mt-0">
            ...
            <Section id="integrated-loyalty">
              ...
              <P>
                In 2020, I was the Sr. Manager for the "Web Buy" team — a team of 3 designers that owned authentication (sign up, sign in, and the various experiences around recognized customers vs. signed-in customers vs. unrecognized "guests"), web bag, checkout, profile, and post-purchase communication and management.
              </P>
              <P>
                I <strong>led UX design for all non-marketing web experiences</strong> within the integrated loyalty initiative across all brands. We owned the end-to-end loyalty experience across the shopping journey, while the App Buy team extended our patterns to mobile. We also <strong>partnered closely with the loyalty marketing team</strong> to guide content and ensure consistency across touchpoints. I was responsible for making all changes to all of these surfaces needed for the integrated loyalty program. We designed the UX for all of the loyalty program touchpoints a customer would encounter in a standard shopping journey, as well as working closely with the loyalty program marketing team to guide the content of net-new program marketing assets.
              </P>
              <H3 id="the-framework">The framework</H3>
              <P>
                The first step was defining the three workstreams that would guide the UX team's contribution to the integrated loyalty program: Program Foundation; Value Proposition & Omni CX; and Loyalty Self-Service & Account Management.
              </P>
              <Figure
