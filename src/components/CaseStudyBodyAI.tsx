        ...
        >
          ...
          <article className="flex min-w-0 flex-col gap-0">
            ...
            <Section id="the-situation">
              ...
              <P>
                Brand leadership came to us with a brief that was deliberately open: <strong>pilot an AI-generated review summary on the PDP, with any brand that was interested, and see if we could make it succeed</strong>. The technology already existed internally. SCOUT is an LLM-based tool that classifies sentiment, extracts key phrases, identifies recurring themes across thousands of reviews, and generates a concise summary of customer opinions. The ask was: put a UI on it, ship it, and learn.
              </P>
              <P>
                My team owned the PDP across all four brands, which meant any customer-facing AI on a PDP would route through us. There was a precedent worth noting here. A separate UX team dedicated to strategic initiatives for Athleta had recently tried and failed to launch an Athleta AI fashion assistant chatbot. Leadership made the deliberate choice not to give that team the AI review summaries work, even though Athleta was one of the brands most interested in the feature. This work landed on my team instead.
              </P>
              <PlaceholderVisual
