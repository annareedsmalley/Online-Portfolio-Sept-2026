        ...
        >
          ...
          <article className="flex min-w-0 flex-col gap-0">
            ...
            <Section id="the-situation">
              ...
              <P>
                Brand leadership came to us with a brief that was deliberately open: pilot an AI-generated review summary on the PDP, with any brand that was interested, and see if we could make it succeed. The technology already existed internally. SCOUT is an LLM-based tool that classifies sentiment, extracts key phrases, identifies recurring themes across thousands of reviews, and generates a concise summary of customer opinions. The ask was: put a UI on it, ship it, and learn.
              </P>
              <P>
