        ...
        >
          ...
          <article className="flex min-w-0 flex-col gap-0 [&_section:first-of-type_h2]:mt-0">
            ...
            <Section id="scaling">
              ...
              <P>
                I had been here before. The lesson from the Brandable Foundation (Headless UI) migration was that the only way to scale across four brands without burning out is to build the underlying experience as a foundational design system component, with brand expression layered on top through theming. We treated the GenAI Review Summary the same way. The trust patterns (the buckets, the disclaimer, the model-confidence states) were locked at the foundational layer, and the brand styling lived on top.
              </P>
              <P>
